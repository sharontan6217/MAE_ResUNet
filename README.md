...
You will find the following folders after the setup.
    config     -- YAML files configueing the settings of tagging and seperator two engines.
    ...
    seperator  -- The agent to seperate the audio with ResUNet.
    output   -- The seperated audios from the mixed audios.
    evaluation -- The evaluation metrics between source audios constructing the mixed audios with the seperated audios from the mixed audios.
